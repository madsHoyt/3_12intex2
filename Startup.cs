        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
             ...
             app.Use(async (context, next) =>
            {
                context.Response.Headers.Add("Content-Security-Policy",
                    ...
                    "script-src-elem 'self' https://cdn.startbootstrap.com/sb-forms-latest.js https://code.jquery.com/jquery-3.6.0.min.js https://cdn.plot.ly/plotly-latest.min.js https://use.fontawesome.com/releases/v6.3.0/js/all.js https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js https://fonts.googleapis.com/css?family=Montserrat:400,700  https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js ;" +
                    "style-src 'self' 'sha256-vJP66++gXP+5BHaPBuciXrdQiwJkDpcXCbxM+tt2D0g=' 'sha256-47DEQpj8HBSa+/TImW+5JCeuQeRkm5NMpJWZG3hSuFU=' 'sha256-Jc7XaRBVYMy6h6FvjL32miHrOGOxYV+OP4swZ/9Gysw=' 'sha256-Jc7XaRBVYMy6h6FvjL32miHrOGOxYV+OP4swZ/9Gysw=' 'sha256-47DEQpj8HBSa+/TImW+5JCeuQeRkm5NMpJWZG3hSuFU=' https://fonts.googleapis.com/css?family=Montserrat:400,700 https://fonts.googleapis.com/css?family=Roboto+Slab:400,100,300,700 ; " +
